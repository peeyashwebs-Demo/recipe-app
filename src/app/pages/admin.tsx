  ...
  if (!store.currentUser || store.currentUser.role !== "admin") {
    return (
      <div className="mx-auto max-w-2xl px-4 py-28 text-center">
        ...
        <p className="text-muted-foreground mt-2">This area is private to the site owner's account.</p>
        {!store.currentUser
          ? <Button className="rounded-full mt-6" onClick={() => openAuth("signin")}>Sign in</Button>
